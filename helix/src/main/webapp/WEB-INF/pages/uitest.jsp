<html lang="en" class=""><head><link rel="icon" type="image/png" href="/static/images/favicon.ico">
                        ...
                        <div class="feed_item">
                           <div class="joke">
                              <div class="joke_wrapper">
                                 ...
                                 <button id="create-tweet" type="submit" tabindex="0" style="margin-top: 10px;">
