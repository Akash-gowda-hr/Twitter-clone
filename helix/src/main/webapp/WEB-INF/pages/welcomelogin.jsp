...
<head>
    ...
    * {
    ...
    #signup-form button {
      background-image: -webkit-linear-gradient(-45deg, #00acee  0%, #ffb199 100%);
      background-image: -moz-linear-gradient(-45deg, #00acee  0%, #ffb199 100%);
      background-image: linear-gradient(-45deg, #00acee  0%, #ffb199 100%);
      border: none;
      border-radius: 30px;
      color: #fff;
      cursor: pointer;
            ...
            "password" : password
                ...
                $.ajax({
                  ...
                  if(!!response)
                  {
                    ...
                    {
                    //location.href is a javascript which redirect to that page
