...
public class LoginController extends BaseController {
    ...
    public
    @ResponseBody
    LoginResponse signUPData(@RequestBody Member member, HttpServletRequest request, HttpServletResponse response) {
     ...
     if(x != null && x.size() > 0)
     {
         ...
         return new LoginResponse(memberTemp.id,true,"Login Successfull");
     }
     else
     {
         //incorrect credentials or not sinup before
