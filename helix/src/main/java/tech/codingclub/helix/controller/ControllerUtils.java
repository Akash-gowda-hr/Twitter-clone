...
public class ControllerUtils {
    ...
    public static void setUserSession(HttpServletRequest httpServletRequest, Member team) {
        httpServletRequest.getSession().setAttribute("I", team.id);//this line automatically set the cookies when login button is pressed
        //getSession() is the key value pair ie. Hashmap genrally cookies
