...
public class UserController extends BaseController {
    ...
    public String userwelcome1(ModelMap modelMap, HttpServletResponse response, HttpServletRequest request) {
    ...
    public
    @ResponseBody
    List<TweetUI> publicpage(@PathVariable("id") Long id, HttpServletRequest request, HttpServletResponse response) {
        ...
        Condition conditionMemeber = tech.codingclub.helix.tables.Member.MEMBER.ID.in(memberIds);
        List<Member> members = (List<Member>) GenericDB.getRows(tech.codingclub.helix.tables.Member.MEMBER,Member.class,conditionMemeber,null);
        ...
        ArrayList<TweetUI> tweetui = new ArrayList<TweetUI>();
    ...
    String unFollowMember(@PathVariable("member_id") Long memberId, HttpServletRequest request, HttpServletResponse response) {
        ...
        if(currentUserId != null && memberId != null && !currentUserId.equals(memberId))
        {
            //Delete the relation between the curentuserId and memberId
           ...
           Boolean success = GenericDB.deleteRows(tech.codingclub.helix.tables.Follower.FOLLOWER,condition);
