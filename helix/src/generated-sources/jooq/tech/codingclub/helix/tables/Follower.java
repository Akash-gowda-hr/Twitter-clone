...
public class Follower extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.FollowerRecord> {
	...
	private static final long serialVersionUID = 367787834;
	...
	public java.util.List<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.FollowerRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.FollowerRecord>>asList(tech.codingclub.helix.Keys.UNIQUE);
	}
	...
	public java.util.List<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>>asList(tech.codingclub.helix.Keys.FOLLOWER__FOLLOWER_TO_MEMBER, tech.codingclub.helix.Keys.FOLLOWER__FK);
	}
